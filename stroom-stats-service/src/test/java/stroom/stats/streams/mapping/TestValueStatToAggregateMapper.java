...
public class TestValueStatToAggregateMapper {

    private static final Logger LOGGER = LoggerFactory.getLogger(TestValueStatToAggregateMapper.class);
    ...
    private ValueStatToAggregateMapper valueStatToAggregateMapper;
    ...
    public void setup() {
        ...
        valueStatToAggregateMapper = new ValueStatToAggregateMapper(mockUniqueIdCache, mockStroomPropertyService);
    }
    ...
    private void assertOnKeyValue(KeyValue<StatKey, StatAggregate> keyValue, Statistics.Statistic statistic, StatisticConfiguration statisticConfiguration) {
        ...
        Assertions.assertThat(statAggregate).isExactlyInstanceOf(ValueAggregate.class);

        ValueAggregate valueAggregate = (ValueAggregate) statAggregate;
        Assertions.assertThat(valueAggregate.getAggregatedValue()).isEqualTo(statistic.getValue());
        Assertions.assertThat(valueAggregate.getEventIds()).hasSize(2);
