...
public class TestBasicCorrelator {
    ...
    public void testComplement() {
        Collection<List<Object>> complementOfB = new BasicCorrelator<List<Object>>()
                .addSet(SET_A, A)
                .addSet(SET_B, B)
                .complement(SET_B);

        assertThat(complementOfB.size()).isEqualTo(1);
        assertThat(complementOfB.iterator().next().get(0)).isEqualTo("user3");
        assertThat(complementOfB.iterator().next().get(1)).isEqualTo("door1");
    }

    @Test
    public void test_intersection_with_2_sets() {
        Collection<List<Object>> intersectionOfAandB = new BasicCorrelator<List<Object>>()
                .addSet(SET_A, A)
                .addSet(SET_B, B)
